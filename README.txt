...
a persistence unit "microprofile-jwtPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "microprofile-jwt\pom.xml":
...
artifact ("microprofile-jwt.war") is already built. You can build
